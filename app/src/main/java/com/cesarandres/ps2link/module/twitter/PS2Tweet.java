...
public class PS2Tweet implements Comparable<PS2Tweet> {
    ...
    /**
     * @param id
     *            id of this tweet. This is unique for every tweet
     * @param user
     *            user that originally created or retweeted this tweet
     * @param date
     *            unix time of when this tweet was created
     * @param content
     *            text contained in this tweet
     * @param tag
     *            tag or alias of the user
     * @param imgUrl
     *            url to retrieve the image of the user
     */
    ...
    /**
     * @param user
     *            the user that created this tweet
     */
    ...
    /**
     * @param date
     *            the unix date when this tweet was created
     */
    ...
    /**
     * @param id
     *            the unique identifier for this tweeet
     */
    ...
    /**
     * @param imgUrl
     *            the url of the thumbnail for this tweet
     */
