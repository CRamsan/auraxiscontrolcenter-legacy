...
public class QueryString {
    ...
    public static enum QueryCommand {
        SHOW("c:show"), HIDE("c:hide"), SORT("c:sort"), HAS("c:has"), JOIN("c:join"), RESOLVE("c:resolve"), CASE("c:case"), LIMIT("c:limit"), LIMITPERDB(
                "c:limitPerDB"), INCLUDENULL("c:includeNull"), START("c:start");
