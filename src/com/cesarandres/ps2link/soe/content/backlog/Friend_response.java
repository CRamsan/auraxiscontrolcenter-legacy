...
public class Friend_response {
    private List<String> characters_friend_list;
    private boolean internal;
    private Number returned;
    private Timing timing;

    public List<String> getCharacters_friend_list() {
	return this.characters_friend_list;
    }

    public void setCharacters_friend_list(List<String> characters_friend_list) {
