package com.cesarandres.ps2link.lib.module;
...
public class SQLiteManager extends SQLiteOpenHelper {
	...
	private static final String CREATE_WORLDS_TABLE = "create table " + TABLE_WORLDS_NAME + " ( " 
			+ WORLDS_COLUMN_ID + " Int, " 
			+ WORLDS_COLUMN_STATE + " Int, " 
			+ WORLDS_COLUMN_NAME + " varchar(-1), " 
			+ "PRIMARY KEY (" + WORLDS_COLUMN_ID + "));";

	private static final String CREATE_FACTIONS_TABLE = "create table " + TABLE_FACTIONS_NAME + " ( " 
			+ FACTIONS_COLUMN_ID + " Int, " 
			+ FACTIONS_COLUMN_NAME + " varchar(-1), " 
			+ FACTIONS_COLUMN_CODE + " varchar(-1), " 
			+ FACTIONS_COLUMN_ICON + " Int, " 
			+ "PRIMARY KEY (" + FACTIONS_COLUMN_ID + "));";

	private static final String CREATE_CHARACTERS_TABLE = "create table " + TABLE_CHARACTERS_NAME + " ( " 
			+ CHARACTERS_COLUMN_ID + " varchar(-1), "
			+ CHARACTERS_COLUMN_NAME_FIRST + " varchar(-1), " 
			+ CHARACTERS_COLUMN_NAME_FIRST_LOWER + " varchar(-1), " 
			+ CHARACTERS_COLUMN_ACTIVE_PROFILE_ID + " Int, " 
			...
			+ CHARACTERS_COLUMN_OUTFIT_NAME + " varchar(-1), "
	...
	private static final String CREATE_MEMBERS_TABLE = "create table " + TABLE_MEMBERS_NAME + " ( " 
	...
	private static final String CREATE_OUTFITS_TABLE = "create table " + TABLE_OUTFITS_NAME + " ( " 
			+ OUTFIT_COLUMN_ID + " varchar(-1), " 
			+ OUTFIT_COLUMN_NAME + " varchar(-1), " 
	...
	private static final String CREATE_TWEETS_TABLE = "create table " + TABLE_TWEETS_NAME + " ( " 
